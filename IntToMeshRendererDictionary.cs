...
using VRC.Udon;
    ...
    public class IntToMeshRendererDictionary : UdonSharpBehaviour
    {
         int[][] _keys;
        MeshRenderer[][] _values;
        int _size;
        ...
        public void SetCapacity(int capacity)
        {
            ...
            _values=new MeshRenderer[len][];
            for(int i=0;i<len;i++){
                _values[i]=new MeshRenderer[bucketCount];
            }
        ...
        public bool Add(int key, MeshRenderer value)
        {
            int index = Hash(key);
            var hashKeys=_keys[index];
            if(index==0){
        ...
        public bool AddOrSetValue(int key,MeshRenderer value){
            int index = Hash(key);
            var hashKeys=_keys[index];
            if(index==0){
                if(key==int.MaxValue){
        ...
        public void SetValue(int key, MeshRenderer value)
        {
            int index = Hash(key);
            var hashKeys=_keys[index];
            if(index==0){
        ...
        public MeshRenderer GetValue(int key)
        {
            int index = Hash(key);
            var hashKeys=_keys[index];
            var hashValues=_values[index];
